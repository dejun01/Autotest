...
#ENV: prod_sbase_smoke_product
  ...
  Scenario: create product
    ...
    Given Add a new product with data
      ...
      | @NameProduct@ | Made from 100% heavyweight cotton, this is the ultimate basic T-shirt. | https://img.btdmp.com/10209/10209304/products/162340294897d75990eb.jpeg | Logo1.jpg | 2 / 500     | Shirt        | Uniqlo | tag1, tag2, tag3 | 10    | 20               | 5             | A123456B | B654321A | ShopBase tracks this product's inventory | 100      | 50     |
