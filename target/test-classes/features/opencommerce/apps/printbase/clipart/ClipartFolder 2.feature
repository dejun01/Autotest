...
#EVM: pbase_clipart_folder
#Pre-condition
  Scenario: Delete all folder
    And Delete all folders by API

#Create clipart folder
  Scenario Outline: Create clipart folder #SB_PRB_CPF_48 #SB_PRB_CPF_40 #SB_PRB_CPF_39 #SB_PRB_CPF_44 #SB_PRB_CPF_45
    ...
    And delete info clipart folder as "06"
      | KEY | ImageThumbnail |
      | 06  | image          |
...
#Edit clipart folder
  Scenario Outline: Edit clipart folder #SB_PRB_CPF_57 #SB_PRB_CPF_56 #SB_PRB_CPF_55 #SB_PRB_CPF_54 #SB_PRB_CPF_53 #SB_PRB_CPF_49
    Given Description: "<Testcase>"
    Given user login to shopbase dashboard by API
    And user navigate to "Library>Cliparts" screen
...
#List clipart folder
  Scenario Outline: List clipart folder #SB_PRB_CPF_52 #SB_PRB_CPF_51  #SB_PRB_CPF_50 #SB_PRB_CPF_48 #SB_PRB_CPF_41
    Given Description: "<Testcase>"
    Given user login to shopbase dashboard by API
    And user navigate to "Library>Cliparts" screen
