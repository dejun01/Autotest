Feature: Roller - Checkout with paypal pro
  #env = sbase_checkout_paypal_pro
  Background:
    Given clear all data

  Scenario: Checkout success by Paypal Pro #SB_CHE_PPP_8 #SB_CHE_PPP_14
  ...
  Scenario: Checkout success by Paypal Pro with post purchase item #SB_CHE_PPP_10 #SB_CHE_PPP_12
    Given open shop on storefront
  ...
  Scenario: Checkout success by Paypal Pro without post purchase item #SB_CHE_PPP_11 #SB_CHE_PPP_13
    Given open shop on storefront
    And add products "Post Purchase" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 3. Failed Authentication #SB_CHE_PPP_16
    Given open shop on storefront
    And add products "Post Purchase" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 4. Attempts/Non-Participating #SB_CHE_PPP_17
    Given open shop on storefront
    And add products "Post Purchase" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 5. Timeout #SB_CHE_PPP_18
    Given open shop on storefront
    And add products "Shirt" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 6. Not Enrolled #SB_CHE_PPP_19
    Given open shop on storefront
    And add products "Shirt" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 7. Unavailable #SB_CHE_PPP_20
    Given open shop on storefront
    And add products "Shirt" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 8. Merchant Not Active #SB_CHE_PPP_21
    Given open shop on storefront
    And add products "Shirt" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 9. cmpi_lookup error #SB_CHE_PPP_22
    Given open shop on storefront
    And add products "Shirt" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 12. Bypassed Authentication #SB_CHE_PPP_25
    Given open shop on storefront
    And add products "Shirt" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 10. cmpi_authenticate error #SB_CHE_PPP_23
    Given open shop on storefront
    And add products "Post Purchase" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 11. Authentication Unavailable #SB_CHE_PPP_24
    Given open shop on storefront
    And add products "Shirt" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
  ...
  Scenario: Checkout by Paypal Pro in case 2. Failed Signature #SB_CHE_PPP_15
    Given open shop on storefront
    And add products "Post Purchase" to cart then navigate to checkout page
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
