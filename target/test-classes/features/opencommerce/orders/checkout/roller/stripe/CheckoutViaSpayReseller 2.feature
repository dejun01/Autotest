Feature:Roller - Checkout Viva Spay Reseller
#  env = spay_reseller_checkout
...
Scenario: Checkout via Spay successfully
  ...
  Scenario: Checkout via Spay Reseller with adding item from post-purchase
    Given open shop on storefront
  ...
  Scenario: Checkout via Spay Reseller without adding item from post-purchase
    Given open shop on storefront
    And add products "Post Purchase" to cart then checkout
    When input Customer information
      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
...
#  Scenario: Checkout via Spay Reseller successfully with 3DS
#    Given open shop on storefront
#    And add products "Bikini" to cart then checkout
#    When input Customer information
#      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
...
#    And close browser
#
#  Scenario: Checkout via Spay Reseller unsuccessfully with 3DS
#    Given open shop on storefront
#    And add products "Bikini" to cart then checkout
#    When input Customer information
#      | Email            | First Name | Last Name | Address           | Country       | City         | Zip code | State      | Phone      |
