...
#  inside theme
#  Env: prod_roller-cartgoal
#  staging_roller-cartgoal
#  dev_roller-cartgoal
...
#  Products: Face Lifting 3 in 1>31.99, Cairbull Cycling Helmet>60
  ...
  Scenario Outline: cart goal #SB_OLS_THE_ROL_115
    ...
    Then verify cart goal work on sf "<KEY>"
      ...
      | 001 | true             | Buy $68.01 USD more to enjoy FREE Shipping 1 |                                                | 100         | Face Lifting 3 in 1     | 31.99       |
